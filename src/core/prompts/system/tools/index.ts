...
const toolDescriptionMap: Record<ToolName, (args: ToolArgs) => string | undefined> = {
	execute_command: (args) => getExecuteCommand(args),
	read_file: (args) => getReadFile(args),
	write_to_file: (args) => getWriteFile(args),
	replace_in_file: (args) => getReplaceInFile(args),
	...
	attempt_completion: (args) => getAttemptCompletion(args),
	new_task: () => getNewTask(),
	plan_mode_respond: (args) => getPlanModeRespond(args),
