...
export function getBrowserAction(browserSettings: BrowserSettings): string {
	const viewportWidth = browserSettings.viewport.width
	const viewportHeight = browserSettings.viewport.height
